...
[![P99](https://img.shields.io/badge/32concurrent_P99-28.97ms-blue)]()
...
### 32-concurrent (50k vectors, 16 shards, Off-heap)
...
### Capacity (100k / 200k vectors)

| Scale | Search P50 | Search P99 | HeapSys (Off-heap) |
|-------|-------------|-------------|--------------------|
...
│   ├── search_pool.go # Local queues
│   ├── block.go      # Heap blocks
│   ├── block_offheap.go  # Off-heap blocks (CGO)
│   └── ...
